...
function populateCustomSearchEngineMenu() {
  ...
  for (const [key, value] of Object.entries(SEARCH_ENGINES)) {
    ...
    // Some basic hardcoded icons since we don't have URLs for all in defaults.js right now
    // We will just use google favicon service as a fallback for the label
    let domain = "google.com";
    if (key === "bing") domain = "bing.com";
    else if (key === "baidu") domain = "baidu.com";
    else if (key === "duckduckgo") domain = "duckduckgo.com";
    else if (key === "custom") domain = "example.com";

    li.innerHTML = `<img src="https://www.google.com/s2/favicons?domain_url=${domain}&sz=64" alt="icon">${value.label}`;
...
function renderSearchSelectValue() {
  ...
  if (el.searchEngineName && el.searchEngineIcon) {
    ...
    let domain = "google.com";
    if (engineKey === "bing") domain = "bing.com";
    else if (engineKey === "baidu") domain = "baidu.com";
    else if (engineKey === "duckduckgo") domain = "duckduckgo.com";
    else if (engineKey === "custom") domain = "example.com";

    el.searchEngineIcon.src = `https://www.google.com/s2/favicons?domain_url=${domain}&sz=64`;
  }
