...
function renderQuickLinks() {
  ...
  for (const link of links) {
    ...
    image.alt = "";
    image.src = \https://www.google.com/s2/favicons?domain_url=\&sz=64\;
  ...
  // Add the "Add Shortcut" card at the end
...
function renderTodoWidget() {
  ...
  document.getElementById("todo-widget").style.display = enabled ? "block" : "none";
  if (!enabled) return;
